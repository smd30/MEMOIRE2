# Test de l'API d'inscription avec email unique
Write-Host "=== Test de l'API d'Inscription (Email Unique) ===" -ForegroundColor Green
Write-Host ""

# Générer un email unique basé sur le timestamp
$timestamp = Get-Date -Format "yyyyMMddHHmmss"
$uniqueEmail = "diop.sokhna.$timestamp@example.com"
...
Write-Host "Données de test (email unique):" -ForegroundColor Yellow
