...
echo "🎯 TEST FINAL - EMAIL AU PROPRIÉTAIRE DU VÉHICULE\n";
echo "=================================================\n\n";

$url = 'http://localhost:8000/api/souscription-proprietaire';
...
if ($response === false) {
    ...
    if ($responseData['success']) {
        ...
        if (isset($responseData['data']['email_destinataire'])) {
            echo "   • Email destinataire: " . $responseData['data']['email_destinataire'] . "\n";
        }
