...
/**
 * Script de configuration automatique pour Laravel
 * Ce script configure l'environnement et installe les dépendances
 */

echo "🚀 Configuration automatique de Laravel...\n";
