...
class SouscriptionFinalController extends Controller
{
    public function souscrire(Request $request)
    {
        try {
            ...
            // Envoyer l'email simple AU PROPRIÉTAIRE DU VÉHICULE
            $emailSent = false;
            try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Contrat créé avec succès ! ' . ($emailSent ? 'Email envoyé au propriétaire du véhicule.' : 'Email sera envoyé prochainement.'),
                'data' => [
                    'contrat' => [
                        'id' => $contrat->id,
                    ...
                    'message' => $emailSent ? 
                        'Votre contrat a été créé avec succès. Un email a été envoyé au propriétaire du véhicule.' : 
                        'Votre contrat a été créé avec succès. L\'email sera envoyé prochainement.'
                ]
            ]);
