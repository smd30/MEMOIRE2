...
class SouscriptionSimpleProprietaireController extends Controller
{
    public function souscrire(Request $request)
    {
        try {
            ...
            // Créer le contrat avec les données du formulaire
            ...
            try {
                ...
                // Envoyer l'email SIMPLE avec le PDF attaché AU PROPRIÉTAIRE DU VÉHICULE
                try {
                    ...
                    $tempPath = storage_path('app/temp/attestation_' . $contrat->numero_attestation . '_' . time() . '.pdf');
                    ...
                    \Illuminate\Support\Facades\Mail::raw($emailContent, function ($message) use ($user, $contrat, $tempPath) {
                    ...
                    \Log::error('Erreur envoi email avec PDF:', ['error' => $e2->getMessage()]);
                }
                ...
                try {
                    ...
                    \Log::error('Erreur envoi email simple:', ['error' => $e3->getMessage()]);
                }
            }
